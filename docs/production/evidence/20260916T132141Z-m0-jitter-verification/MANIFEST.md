# Jepsen evidence — m0-jitter-verification

| 字段 | 值 |
|:--|:--|
| 场景 | `m0-jitter-verification` |
| UTC 时间戳 | `20260916T132141Z` |
| run 开始 / 结束 | 2026-09-16 13:16:08,652 / unknown |
...
lein run -m clojure.main scripts/replay.clj store/coord/2026-09-16T13:16:08.631597289Z --seed 42
# 重跑 checker（不需要集群）
lein run -m clojure.main scripts/validate-soak-checker.clj store/coord/2026-09-16T13:16:08.631597289Z
```
