# Jepsen evidence — t2.1-watch-120s-kill-f21

| 字段 | 值 |
|:--|:--|
| 场景 | `t2.1-watch-120s-kill-f21` |
| UTC 时间戳 | `20260917T134011Z` |
| run 开始 / 结束 | 2026-09-17 11:25:37,593 / unknown |
...
lein run -m clojure.main scripts/replay.clj store/coord/2026-09-17T11:25:37.569047407Z --seed 1783726406
# 重跑 checker（不需要集群）
lein run -m clojure.main scripts/validate-soak-checker.clj store/coord/2026-09-17T11:25:37.569047407Z
```
