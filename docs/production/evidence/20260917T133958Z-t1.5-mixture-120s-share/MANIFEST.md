# Jepsen evidence — t1.5-mixture-120s-share

| 字段 | 值 |
|:--|:--|
| 场景 | `t1.5-mixture-120s-share` |
| UTC 时间戳 | `20260917T133958Z` |
| run 开始 / 结束 | 2026-09-17 10:44:48,244 / unknown |
...
| 随机种子 | **798182699** |
| 命令行（jepsen.log 记录） | `lein run test --nodes-file /root/nodes --username root --ssh-private-key /root/.ssh/id_ed25519 --workload mixture --nemesis none --time-limit 60 --concurrency 1n` |
...
lein run -m clojure.main scripts/replay.clj store/coord/2026-09-17T10:44:48.22018714Z --seed 798182699
# 重跑 checker（不需要集群）
lein run -m clojure.main scripts/validate-soak-checker.clj store/coord/2026-09-17T10:44:48.22018714Z
```
