# Jepsen evidence — t2.3-m2-watch-lease-2h-f69-fixed

| 字段 | 值 |
|:--|:--|
| 场景 | `t2.3-m2-watch-lease-2h-f69-fixed` |
| UTC 时间戳 | `20260925T185131Z` |
| run 开始 / 结束 | 2026-09-25 16:40:27,897 / unknown |
| coord commit | `eb91d5818026f3e896b27240a77dfc7f8119ec19` (soak-params-2026-09-18-39-geb91d58, 2026-09-25T16:30:09Z) |
| 工作树 | **clean** |
...
| history.edn | history.edn.gz — yes (source 14058029 bytes) |
...
lein run -m clojure.main scripts/replay.clj store/coord/2026-09-25T16:40:27.876181482Z --seed 42
# 重跑 checker（不需要集群）
lein run -m clojure.main scripts/validate-soak-checker.clj store/coord/2026-09-25T16:40:27.876181482Z
```
