# Jepsen evidence — t2.1-watch-120s-kill-f20

| 字段 | 值 |
|:--|:--|
| 场景 | `t2.1-watch-120s-kill-f20` |
| UTC 时间戳 | `20260917T134009Z` |
| run 开始 / 结束 | 2026-09-17 11:21:37,871 / unknown |
...
lein run -m clojure.main scripts/replay.clj store/coord/2026-09-17T11:21:37.845519254Z --seed 742834458
# 重跑 checker（不需要集群）
lein run -m clojure.main scripts/validate-soak-checker.clj store/coord/2026-09-17T11:21:37.845519254Z
```
