# Jepsen evidence — t1.5-mixture-45s-kill

| 字段 | 值 |
|:--|:--|
| 场景 | `t1.5-mixture-45s-kill` |
| UTC 时间戳 | `20260917T134001Z` |
| run 开始 / 结束 | 2026-09-17 11:04:46,184 / unknown |
...
| 随机种子 | **1906351596** |
| 命令行（jepsen.log 记录） | `lein run test --nodes-file /root/nodes --username root --ssh-private-key /root/.ssh/id_ed25519 --workload idempotency --nemesis none --time-limit 45 --concurrency 2n` |
...
lein run -m clojure.main scripts/replay.clj store/coord/2026-09-17T11:04:46.160213597Z --seed 1906351596
# 重跑 checker（不需要集群）
lein run -m clojure.main scripts/validate-soak-checker.clj store/coord/2026-09-17T11:04:46.160213597Z
```
