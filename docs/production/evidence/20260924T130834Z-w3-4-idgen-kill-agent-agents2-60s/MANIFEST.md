# Jepsen evidence — w3-4-idgen-kill-agent-agents2-60s

| 字段 | 值 |
|:--|:--|
| 场景 | `w3-4-idgen-kill-agent-agents2-60s` |
| UTC 时间戳 | `20260924T130834Z` |
| run 开始 / 结束 | 2026-09-24 12:52:02,296 / unknown |
...
| 随机种子 | **1822266891** |
| 命令行（jepsen.log 记录） | `lein run test --nodes-file /root/nodes --username root --ssh-private-key /root/.ssh/id_ed25519 --workload idgen --nemesis kill-agent --time-limit 60 --concurrency 2n --agents 2 --idgen-min-ids 10` |
...
lein run -m clojure.main scripts/replay.clj store/coord/2026-09-24T12:52:02.273183239Z --seed 1822266891
# 重跑 checker（不需要集群）
lein run -m clojure.main scripts/validate-soak-checker.clj store/coord/2026-09-24T12:52:02.273183239Z
```
