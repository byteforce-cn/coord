# Jepsen evidence — w1-2-f05-kill-all-60s-run2

| 字段 | 值 |
|:--|:--|
| 场景 | `w1-2-f05-kill-all-60s-run2` |
| UTC 时间戳 | `20260924T130839Z` |
| run 开始 / 结束 | 2026-09-24 13:03:09,946 / unknown |
...
lein run -m clojure.main scripts/replay.clj store/coord/2026-09-24T13:03:09.922280021Z --seed 138033292
# 重跑 checker（不需要集群）
lein run -m clojure.main scripts/validate-soak-checker.clj store/coord/2026-09-24T13:03:09.922280021Z
```
