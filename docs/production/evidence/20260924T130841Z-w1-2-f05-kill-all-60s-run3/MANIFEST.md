# Jepsen evidence — w1-2-f05-kill-all-60s-run3

| 字段 | 值 |
|:--|:--|
| 场景 | `w1-2-f05-kill-all-60s-run3` |
| UTC 时间戳 | `20260924T130841Z` |
| run 开始 / 结束 | 2026-09-24 13:06:05,529 / unknown |
...
lein run -m clojure.main scripts/replay.clj store/coord/2026-09-24T13:06:05.506637265Z --seed 85098182
# 重跑 checker（不需要集群）
lein run -m clojure.main scripts/validate-soak-checker.clj store/coord/2026-09-24T13:06:05.506637265Z
```
