# Jepsen evidence — m5b-mq-multi-client-checker-artifact

| 字段 | 值 |
|:--|:--|
| 场景 | `m5b-mq-multi-client-checker-artifact` |
| UTC 时间戳 | `20260920T133301Z` |
| run 开始 / 结束 | 2026-09-20 13:25:59,220 / unknown |
...
lein run -m clojure.main scripts/replay.clj store/coord/2026-09-20T13:25:59.190588759Z --seed 1490379652
# 重跑 checker（不需要集群）
lein run -m clojure.main scripts/validate-soak-checker.clj store/coord/2026-09-20T13:25:59.190588759Z
```
