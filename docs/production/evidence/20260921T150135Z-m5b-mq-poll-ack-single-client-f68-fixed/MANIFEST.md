# Jepsen evidence — m5b-mq-poll-ack-single-client-f68-fixed

| 字段 | 值 |
|:--|:--|
| 场景 | `m5b-mq-poll-ack-single-client-f68-fixed` |
| UTC 时间戳 | `20260921T150135Z` |
| run 开始 / 结束 | 2026-09-21 14:59:31,793 / unknown |
...
| 随机种子 | **1091979256** |
| 命令行（jepsen.log 记录） | `lein run test --nodes-file /root/nodes --username root --ssh-private-key /root/.ssh/id_ed25519 --workload mq --nemesis none --time-limit 60 --concurrency 1 --agents 1` |
...
lein run -m clojure.main scripts/replay.clj store/coord/2026-09-21T14:59:31.768458009Z --seed 1091979256
# 重跑 checker（不需要集群）
lein run -m clojure.main scripts/validate-soak-checker.clj store/coord/2026-09-21T14:59:31.768458009Z
```
