# Jepsen evidence — t1.5-mixture-soak-2h

| 字段 | 值 |
|:--|:--|
| 场景 | `t1.5-mixture-soak-2h` |
| UTC 时间戳 | `20260917T134013Z` |
| run 开始 / 结束 | 2026-09-17 11:34:40,837 / unknown |
...
lein run -m clojure.main scripts/replay.clj store/coord/2026-09-17T11:34:40.812005485Z --seed 42
# 重跑 checker（不需要集群）
lein run -m clojure.main scripts/validate-soak-checker.clj store/coord/2026-09-17T11:34:40.812005485Z
```
