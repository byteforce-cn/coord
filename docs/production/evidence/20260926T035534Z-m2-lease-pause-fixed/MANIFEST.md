# Jepsen evidence — m2-lease-pause-fixed

| 字段 | 值 |
|:--|:--|
| 场景 | `m2-lease-pause-fixed` |
| UTC 时间戳 | `20260926T035534Z` |
| run 开始 / 结束 | 2026-09-26 03:52:18,506 / unknown |
...
lein run -m clojure.main scripts/replay.clj store/coord/2026-09-26T03:52:18.48477138Z --seed 1762609241
# 重跑 checker（不需要集群）
lein run -m clojure.main scripts/validate-soak-checker.clj store/coord/2026-09-26T03:52:18.48477138Z
```
