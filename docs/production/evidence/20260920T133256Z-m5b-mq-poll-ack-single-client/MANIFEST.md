# Jepsen evidence — m5b-mq-poll-ack-single-client

| 字段 | 值 |
|:--|:--|
| 场景 | `m5b-mq-poll-ack-single-client` |
| UTC 时间戳 | `20260920T133256Z` |
| run 开始 / 结束 | 2026-09-20 13:30:52,141 / unknown |
| coord commit | `fdbeef3949648806b54e3a703f0bdbda373f5dcc` (soak-params-2026-09-18-4-gfdbeef3, 2026-09-20T11:53:50Z) |
| 工作树 | **DIRTY** |
| coord-proto 哈希（16） | `ff1f5bd63062f8e0` |
...
lein run -m clojure.main scripts/replay.clj store/coord/latest --seed 564221858
# 重跑 checker（不需要集群）
