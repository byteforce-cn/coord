# Jepsen evidence — f3-value-size-4k

| 字段 | 值 |
|:--|:--|
| 场景 | `f3-value-size-4k` |
| UTC 时间戳 | `20260917T134002Z` |
| run 开始 / 结束 | 2026-09-17 11:06:13,947 / unknown |
...
| 随机种子 | **85653150** |
| 命令行（jepsen.log 记录） | `lein run test --nodes-file /root/nodes --username root --ssh-private-key /root/.ssh/id_ed25519 --workload map --nemesis kill --time-limit 60 --concurrency 1n --value-size 4096` |
...
lein run -m clojure.main scripts/replay.clj store/coord/2026-09-17T11:06:13.923555841Z --seed 85653150
# 重跑 checker（不需要集群）
lein run -m clojure.main scripts/validate-soak-checker.clj store/coord/2026-09-17T11:06:13.923555841Z
```
