# Jepsen evidence — t1.4-idempotency-seed42

| 字段 | 值 |
|:--|:--|
| 场景 | `t1.4-idempotency-seed42` |
| UTC 时间戳 | `20260916T132105Z` |
| run 开始 / 结束 | 2026-09-16 13:18:38,933 / unknown |
...
lein run -m clojure.main scripts/replay.clj store/coord/2026-09-16T13:18:38.911049557Z --seed 42
# 重跑 checker（不需要集群）
lein run -m clojure.main scripts/validate-soak-checker.clj store/coord/2026-09-16T13:18:38.911049557Z
```
