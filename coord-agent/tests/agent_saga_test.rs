...
use coord_agent::saga::{SagaConfig, SagaContext, SagaService, SagaState, SagaStep, StepResult};
...
fn test_saga_compensation_on_failure() {
    ...
    svc.add_step(
        ...
        SagaStep {
            ...
            action: Box::new(|_ctx: &mut SagaContext| Err("step2 intentional failure".to_string())),
            compensation: Box::new(|ctx: &mut SagaContext| {
