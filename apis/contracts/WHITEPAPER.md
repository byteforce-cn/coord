...
1. **承诺面服务已在契约包名下**：§1.3 全部 17 项能力的实现已从
   ...
   （契约消费预览不受限）。
2. **生产就绪验收未全部通过**（计划书 §4 九门）：独立 Jepsen、72h 浸泡、
   kind 部署验证证据缺失（P0-03/R10）。**第三方安全审计不再作为验收门槛**
   （2026-09-25 决策：无经费采买/执行；替代物 = 「未经独立第三方安全审计」的边界声明，
   见计划书 §8.7）——该变更**不改变**"未经独立审计"这一事实，任何声明不得暗示已审计。
